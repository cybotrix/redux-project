        ...
        <div className="row">
            ...
            <div className="col-xl-6 mb-4 ">
                    <div className="card border-0 shadow-lg">
                        <div className="card-header bg-info text-white"> <i class="fa fa-info-circle" aria-hidden="true"></i> Basic Imformation </div>
                        <div className="card-body "> 
                                <div className="form-group row">
                                    ...
                                    className="form-control" rows="3" cols="3" maxlength="200"
